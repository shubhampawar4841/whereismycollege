...
export default function YearTrendsPage() {
  ...
  // Fetch branches and rounds when college is selected
  useEffect(() => {
    if (college) {
      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Analyze how cutoff varies across years (2020-2024) for a specific round
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-gradient-to-br from-orange-500/10 to-yellow-600/10 border-orange-500/30">
          <CardHeader>
            ...
            <CardDescription>
              Select college first, then branch and round will be filtered accordingly
            </CardDescription>
          </CardHeader>
